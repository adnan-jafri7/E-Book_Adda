...
import com.adnan.e_book_adda.activity.PdfViewActivity
...
class AllRestaurantsAdapter(private var restaurants: ArrayList<Restaurants>, val context: Context) :
    ...
    override fun onBindViewHolder(p0: AllRestaurantsViewHolder, p1: Int) {
        ...
        p0.cost.text = resObject.costForTwo
        ...
        p0.cardRestaurant.setOnClickListener {
            Toast.makeText(context,"Loading Book Please Wait",Toast.LENGTH_SHORT).show()
            val intent = Intent(context, PdfViewActivity::class.java)
            intent.putExtra("pdf_url",resObject.pdf_url)
